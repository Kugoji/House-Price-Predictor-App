...
if mode == "Model Results Mode":
    ...
    with st.container():
        ...
        \text{House Price} = 
        \beta_0 + 
        \beta_1 \cdot \text{SqFt} + 
        \beta_2 \cdot \text{Beds} + 
        \beta_3 \cdot \text{Baths} + 
        \beta_4 \cdot \text{SE} + 
        \beta_5 \cdot \text{NW} + 
        \beta_6 \cdot \text{NE} + \varepsilon
        $$
        """)
    ...
    with st.container():
        with col9:
            ...
            if model_choice2 == "Basic OLS":
                st.markdown(
            r"""
            $ \text{House Price} = \beta_0 + \beta_1 \cdot \text{SqFt} + \beta_2 \cdot \text{Beds} + \beta_3 \cdot \text{Baths} + \beta_4 \cdot \text{SE} + \beta_5 \cdot \text{NW} + \beta_6 \cdot \text{NE} + \varepsilon $
            """)
